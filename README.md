...
### 3. Benchmarking des Vorgehens

Das Benchmarking dient dazu, die Effektivität des Vorgehens zu bewerten und mögliche Herausforderungen zu identifizieren. Dabei werden zwei zentrale Fragestellungen untersucht:

#### a) Zeitliche Erfassung von Fahrradstraßen in OSM

Es wird analysiert, wie schnell bzw. ob neue **Fahrradstraßen** in OSM getaggt wurden. Hierzu werden die amtlichen Daten zu Fahrradstraßen der Berliner Senatsverwaltung [2] mit den entsprechenden Änderungen in OSM (`bicycle_road=yes`) verglichen. Dies soll insbesondere Einblicke zur Verzögerung (Time Lag) zwischen Maßnahme und OSM-Tagging geben.
...
* **Tabelle: Übersicht der analysierten Kacheln** Wieso nur 2.801?
  ...
  |----------------------------------------------------------------------------------------------------------|---------------:|---------------------------------------------------------------------------------------------------------------|
  | Gesamtanzahl der 1km-Kacheln (Zensus 2022) in Deutschland                                                 |        384.181 |                                                                                                               |
